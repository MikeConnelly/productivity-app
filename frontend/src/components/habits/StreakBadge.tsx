...
export function StreakBadge({ currentStreak, longestStreak }: StreakBadgeProps) {
  return (
    <div className="flex gap-4">
      <div className="flex items-center gap-2 bg-orange-50 dark:bg-orange-900/30 px-4 py-3 rounded-xl">
      ...
      <div className="flex items-center gap-2 bg-yellow-50 dark:bg-yellow-900/30 px-4 py-3 rounded-xl">
