  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 md:py-8">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">My Habits</h1>
        <button
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
          <p className="text-gray-500 dark:text-gray-400 mb-4">No habits yet. Start building good habits!</p>
          <button
            onClick={() => setShowForm(true)}
        ...
        <div className="space-y-3">
          {habits.map((habit) => (
            ...
            >
              ...
              <Link to={`/habits/${habit.habitId}`} className="flex-1 min-w-0">
